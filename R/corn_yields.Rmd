...
Something to notice hear is that we have not stated anything about the distribution of any of the parameters in the model. Two key assumptions that we currently have and will have to verify is that our samples are independent ($corr(\epsilon_i, \epsilon_j)=0$ where $i\not=j$) and the variance is constant.
